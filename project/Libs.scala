...
object Tapir {
  ...
  val `tapir-openapi-circe-yaml`   = "com.softwaremill.sttp.tapir"   %% "tapir-openapi-circe-yaml"   % "0.20.2"
  val `openapi-circe-yaml`         = "com.softwaremill.sttp.apispec" %% "openapi-circe-yaml"         % "0.5.3"
  val `tapir-swagger-ui-akka-http` = "com.softwaremill.sttp.tapir"   %% "tapir-swagger-ui-akka-http" % "0.18.3"
  val `tapir-redoc-akka-http`      = "com.softwaremill.sttp.tapir"   %% "tapir-redoc-akka-http"      % "0.18.3"
}
...
object Akka {
  val Version = "2.6.20" //all akka is Apache License 2.0
  ...
  val `akka-protobuf-v3`         = "com.typesafe.akka" %% "akka-protobuf-v3"         % Version
}
